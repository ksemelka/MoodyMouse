...
int thresholdFrontLeft = 110;//180; //180; //200
int thresholdFrontRight = 90;//160; //230; //250
int thresholdSideLeft = 320;//240;//280;	// Threshold for Wall on side
int thresholdSideRight = 380;//300;//340;
